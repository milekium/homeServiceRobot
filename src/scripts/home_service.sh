...
sleep 5
xterm -e " source ./devel/setup.bash; roslaunch add_markers add_multiple_markers.launch" &
sleep 5
xterm -e " source ./devel/setup.bash; roslaunch pick_objects pick_multiple_objects.launch" 
